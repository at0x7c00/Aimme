package com.huqiao.smartadmin.sys.entity;
...
import com.huqiao.smartadmin.taglib.treeselect.ZTreeNode;
...
public class Department implements ZTreeNode {
	 ...
	 */
	@ManyToOne(targetEntity = com.huqiao.smartadmin.sys.entity.Department.class, fetch = FetchType.LAZY)
