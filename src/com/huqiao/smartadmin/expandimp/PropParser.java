package com.huqiao.smartadmin.expandimp;
...
import com.huqiao.smartadmin.datamodel.PropUtil;
...
public class PropParser {
	...
	public static void main(String[] args) {
		...
		for(ModelProp prop : parser.parseProp("com.huqiao.smartadmin.expandimp.Teacher")){
