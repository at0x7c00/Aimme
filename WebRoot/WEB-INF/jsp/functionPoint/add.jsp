							...
							<fieldset>
								<div class="row">
									...
									<section class="col col-3">
										<label class="input">
											<spring:message code="props.com.huqiao.smartadmin.sys.entity.FunctionPoint.name"></spring:message>： 
									...
									<section class="col col-3">
										<label class="input">
										<spring:message code="props.com.huqiao.smartadmin.sys.entity.FunctionPoint.url"/>:
									...
									<section class="col col-3">
										<label class="input">
										<spring:message code="props.com.huqiao.smartadmin.sys.entity.FunctionPoint.icon"/>:
									...
									<section class="col col-3">
										<label class="input">
										<spring:message code="props.com.huqiao.smartadmin.sys.entity.FunctionPoint.isDisplay"/>:
									...
									<section class="col col-3">
										<label class="input">
										<spring:message code="props.com.huqiao.smartadmin.sys.entity.FunctionPoint.orderNum"/>:
									...
									<section class="col col-3">
										<label class="input">
										<spring:message code="props.com.huqiao.smartadmin.sys.entity.FunctionPoint.parent"/>：
