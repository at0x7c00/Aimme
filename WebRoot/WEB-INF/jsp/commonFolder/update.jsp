		...
		<fieldset>
			<div class="row">
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.com.huqiao.smartadmin.sys.entity.CommonFolder.folderName"></spring:message>： 
				...
				<section class="col col-3">
					<label class="input">
						<spring:message code="props.com.huqiao.smartadmin.sys.entity.CommonFolder.storePath"></spring:message>：
