							...
							<fieldset>
								<div class="row">
									<section class="col col-6">
										<label class="input">
											<spring:message code="props.com.huqiao.smartadmin.sys.entity.Role.name"/>: <font color="red">*</font>
								...
								<div class="row">
									<section class="col col-12" style="width:100%;">
										<label class="input">
										<spring:message code="props.com.huqiao.smartadmin.sys.entity.Role.description"/>:
